package de.andrestefanov.popularmovies.data.contentprovider;
...
public class FavoritesProvider extends ContentProvider {
    ...
    public static final String PROVIDER_NAME = "de.andrestefanov.popularmovies.provider";
    ...
    static {
        sUriMatcher.addURI(PROVIDER_NAME, "favorites", 1);
        sUriMatcher.addURI(PROVIDER_NAME, "favorites/#", 2);
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        return db.query("favorites", projection, selection, selectionArgs, null, null, sortOrder);
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        long row = db.insert("favorites", null, values);
    ...
    public int delete(@NonNull Uri uri, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case 2:
                ...
                count = db.delete("favorites", _ID + " = " + id + (!TextUtils.isEmpty(selection) ? " AND (" + selection + ')' : ""), selectionArgs);
                break;
            default:
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        // movie favorite items wont be updated
        return 0;
    }

    // A string that defines the SQL statement for creating a table
    private static final String SQL_CREATE_FAVORITES = "CREATE TABLE " +
            "favorites " +                       // Table's name
     ...
     */
    private static final class FavoritesDatabaseHelper extends SQLiteOpenHelper {
